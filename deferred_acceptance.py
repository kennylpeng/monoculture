...
# Function that takes values and returns the corresponding preference list, with higher values being more preferred
# Parameters:
#   - values: a 1d list of values or a 2d list of lists of values
# Returns:
#   - prefs: a 1d preference list or a 2d list of preference lists
# Examples:
#   prefs_from_values([0.1, 0.2, 0.3]) = [2, 1, 0]
#   prefs_from_values([[0.1, 0.2, 0.3], [3.1, 1.1, 2.1]) = [[2, 1, 0], [0, 2, 1]]
